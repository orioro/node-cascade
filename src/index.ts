// https://github.com/jest-community/eslint-plugin-jest/issues/555
/* eslint-disable jest/no-export, jest/expect-expect, jest/valid-title */
 ...
 */
export type TestFunction = (criteria: Criteria, ...args: any) => boolean
 ...
 * @param {...args[]} args
 */
export const test: TestFunction = (criteria, ...args) => {
...
const _alternativeTest = (
  ...
  (alternative.length === 2 && test(alternative[0], ...args))

const _alternativeValue = (alternative: Alternative) =>
  alternative.length === 1 ? alternative[0] : alternative[1]
